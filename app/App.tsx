    ...
    case 'dewa_kuno':
      return (
        <div className={`absolute inset-0 overflow-hidden bg-[#1a1200] ${className}`}>
           ...
           <div className="absolute -top-1/2 -left-1/2 w-[200%] h-[200%] bg-[conic-gradient(from_0deg,transparent_0%,rgba(253,224,71,0.5)_30%,transparent_50%)] animate-cosmic-spin" />
           <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top_right,rgba(250,204,21,0.5),transparent_50%)] animate-pulse" />
        </div>
      );
    case 'wanglin':
      return (
        <div className={`absolute inset-0 overflow-hidden bg-[#1a0505] ${className}`}>
           <div className="absolute -bottom-1/2 -left-1/2 w-[200%] h-[200%] bg-[conic-gradient(from_90deg,transparent_0%,rgba(220,38,38,0.6)_40%,transparent_80%)] animate-flame-flow" />
           <div className="absolute inset-0 bg-gradient-to-t from-black via-[#8b0000]/70 to-[#ff0000]/50" />
    ...
    case 'dragon':
      return (
        <div className={`absolute inset-0 overflow-hidden bg-slate-950 ${className}`}>
           ...
           <div className="absolute -top-1/2 -left-1/2 w-[200%] h-[200%] animate-dragon-orbit opacity-80" style={{ background: 'conic-gradient(from 180deg, transparent 0%, #fefce8 10%, #fef08a 20%, transparent 40%)' }} />
    ...
    case 'nika':
      return (
        <div className={`absolute inset-0 overflow-hidden bg-orange-950 ${className}`}>
           <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] animate-nika-spin opacity-90" style={{ background: 'conic-gradient(from 0deg, #fef08a 0%, #f97316 25%, #fef08a 50%, #f97316 75%, #fef08a 100%)', filter: 'blur(30px)' }} />
    ...
    case 'sasuke':
      return (
        <div className={`absolute inset-0 overflow-hidden bg-[#1a052b] ${className}`}>
           <div className="absolute -bottom-1/2 -left-1/2 w-[200%] h-[200%] animate-susanoo-pulse opacity-90" style={{ background: 'conic-gradient(from 45deg, transparent 0%, #9333ea 30%, transparent 60%)' }} />
